...
```
cd existing_repo
git remote add origin https://gitlab.obspm.fr/nenufar/cameleon/pysof0273.git
git branch -M main
...
* [Set up project integrations](https://gitlab.obspm.fr/nenufar/cameleon/pysof0273/-/settings/integrations)
